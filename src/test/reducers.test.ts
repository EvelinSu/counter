...
import {
    ...
    changeMinValueAC,
    changeNoticeAC,
    counterReducer, resetCurrentValueAC, TCounter, changeLoadingStatusAC
} from "../redux/countValuesReducer";

let startState: TCounter
...
test ('change loader status', () => {

    const action = changeLoadingStatusAC(true)
    const endState = counterReducer(startState, action)
